...
# Adapted by Suhail aka skyinfo <sh.skyinfo@gmail.com>
...
case "$choice" in
	1 ) target="L3II-"; variant="Single"; echo "$choice - $target$variant"; make skernel_vee3_defconfig &> /dev/null; maindevicecheck="On";;
	2 ) target="L3II-"; variant="Dual"; echo "$choice - $target$variant"; make skernel_vee3ds_defconfig &> /dev/null; maindevicecheck="On";;
	3 ) target="L5-"; variant="Single"; echo "$choice - $target$variant"; make skernel_m4_defconfig &> /dev/null; maindevicecheck="On";;
	4 ) target="L5NoNFC-"; variant="Single"; echo "$choice - $target$variant"; make skernel_m4_nonfc_defconfig &> /dev/null; maindevicecheck="On";;
	5 ) target="L7-"; variant="Single"; echo "$choice - $target$variant"; make skernel_u0_defconfig &> /dev/null; maindevicecheck="On";;
	6 ) target="L7NoNFC-"; variant="Single"; echo "$choice - $target$variant"; make skernel_u0_nonfc_defconfig &> /dev/null; maindevicecheck="On";;
...
zipfile="$customkernel-$target$variant-$version.zip"
